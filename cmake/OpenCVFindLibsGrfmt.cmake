...
if(NOT WEBP_VERSION AND WEBP_INCLUDE_DIR)
  ...
  if(EXISTS "${WEBP_INCLUDE_DIR}/webp/mux.h")
    file(STRINGS "${WEBP_INCLUDE_DIR}/webp/mux.h" WEBP_MUX_ABI_VERSION REGEX "#define[ \t]+WEBP_MUX_ABI_VERSION[ \t]+([x0-9a-f]+)" )
    if(WEBP_MUX_ABI_VERSION MATCHES "#define[ \t]+WEBP_MUX_ABI_VERSION[ \t]+([x0-9a-f]+)")
        set(WEBP_MUX_ABI_VERSION "${CMAKE_MATCH_1}")
    else()
      unset(WEBP_MUX_ABI_VERSION)
    endif()
  endif()
...
set(WEBP_VERSION "decoder: ${WEBP_DECODER_ABI_VERSION} encoder: ${WEBP_ENCODER_ABI_VERSION} mux: ${WEBP_MUX_ABI_VERSION} demux: ${WEBP_DEMUX_ABI_VERSION}")
endif()
