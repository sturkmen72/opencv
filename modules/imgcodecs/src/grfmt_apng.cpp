...
namespace cv
{
    ...
    int APNGOpt::load_apng(std::string inputFileName, std::vector<APNGFrame>& frames, unsigned int& first, unsigned int& loops)
    {
        FILE* f;
    ...
    size_t APNGOpt::save_apng(std::string outputFileName, std::vector<APNGFrame>& frames, unsigned int first, unsigned int loops, unsigned int coltype, int deflate_method, int iter)
    {
        FILE* f;
        unsigned int i, j, k;
