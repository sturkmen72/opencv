...
if(WITH_SPNG)
  if(BUILD_SPNG)
    ocv_clear_vars(SPNG_LIBRARY SPNG_LIBRARIES SPNG_INCLUDE_DIR SPNG_PNG_INCLUDE_DIR HAVE_LIBSPNG_PNG_H SPNG_DEFINITIONS)
  ...
  set(HAVE_SPNG YES)
  set(PNG_VERSION "${SPNG_VERSION_MAJOR}.${SPNG_VERSION_MINOR}.${SPNG_VERSION_PATCH}")
endif()
